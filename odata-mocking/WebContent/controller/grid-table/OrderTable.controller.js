...
(function (controller_1) {
    var OrderTableClass = (function () {
        ...
        OrderTableClass.prototype.getRouter = function () {
            if (!this.ctrl)
                return {};
        ...
        OrderTableClass.prototype.afterInit = function () {
            debugger;
        };
        OrderTableClass.prototype.onBeforeRendering = function (ctrl) {
            return __awaiter(this, void 0, void 0, function () {
                var _a, todos, employees, oModel;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0: return [4, this._getData()];
                        case 1:
            ...
            var oTemplate = new sap.ui.table.RowAction({
                items: [
                    new sap.ui.table.RowActionItem({
                        icon: "sap-icon://edit",
                        text: "Edit",
                        press: function (e) { return _this.edit(e); }
                    }),
                    new sap.ui.table.RowActionItem({
        ...
        OrderTableClass.prototype.edit = function (e) {
            var currentRow = this.getCurrentRowObject(e);
    ...
    function gridDataTableController(controller, jsonModel, messageToast, busyIndicator, DateFormat, service, employeeService) {
        ...
        var extendedController = controller.extend("worklist.controller.grid-table.OrderTable", {
            onSFPressed: function (e) { return gridDataTableClass.onSFPressed(e); },
            onSFSubmitted: function (e) { return gridDataTableClass.onSFSubmitted(e); },
            onSFChanged: function (e) { return gridDataTableClass.onSFChanged(e); },
