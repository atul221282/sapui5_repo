...
(function (viewmodel) {
    ...
    var SimpleFormViewModel = (function () {
        function SimpleFormViewModel(messageToast, dataService, JSONModel) {
        ...
        SimpleFormViewModel.prototype.onInit = function (ctrl) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4, this.dataService.getComments()];
                        case 1:
                            allComments = _a.sent();
                            comments = _.take(allComments, 5);
                            return [4, this.dataService.getTodos()];
                        case 2:
                            todos = _a.sent();
    ...
    viewmodel.SimpleFormViewModel = SimpleFormViewModel;
    sap.ui.define(["sap/m/MessageToast",
        "../service/simple-form-data-service",
        "sap/ui/model/json/JSONModel"
    ], function (m, d, j) {
        return new SimpleFormViewModel(m, d, j);
    });
})(viewmodel || (viewmodel = {}));
