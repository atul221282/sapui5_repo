namespace controller {
    ...
    function gridDataTableController(
        ...
        const extendedController = controller.extend("worklist.controller.grid-table.OrderTable", {
            onSFPressed: (e: any) => gridDataTableClass.onSFPressed(e),
            onSFSubmitted: (e: any) => gridDataTableClass.onSFSubmitted(e),
            onSFChanged: (e: any) => gridDataTableClass.onSFChanged(e),
